...
const findByDateConstruccion = async (date, type = "day") => {
    try {
...
const updateConstruccionById = async (id, updateData) => {
    try {
        ...
        const actualizacion = await LaboralConstruccion.findByIdAndUpdate(
            id,
            updateData,
            {
